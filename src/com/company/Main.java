...
public class Main {
    ...
    //TODO Отображение критического пути
    //TODO Создать сохранение структуры на диск в XML/Json
    //TODO Экспорт/Импорт DrawIO
    //TODO Диаграмма ганта И график загруженности реусурса
    //TODO Импорт/Интеграция из имеющихся программ для работы с диаграммами ганта
    //TODO Аналог Jira
    //TODO Добавление функции переплаинроавния :
    ...
    //-	повторный расчёт критического пути и повторное календарное планирование проекта.
    //TODO Добавление "Оперативное управление" :
    ...
    //TODO Учет специфики работы по Scrum (спринты и беклог)
    //TODO Интеграция с Jira
    //TODO Многопользовательский сервис
